...
var url = require( 'url' );
var debug = require( 'debug' )( 'npm-registry-package-info:request' );


// REQUEST //

/**
* FUNCTION: request( name, options, clbk )
*	Queries an endpoint for package info.
*
...
* @param {Boolean} options.latest - boolean indicating whether to fetch only the latest package info
