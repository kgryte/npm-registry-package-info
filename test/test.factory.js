...
test( 'function returns a function which returns an error to a provided callback if an error is encountered when fetching package info', function test( t ) {
	var factory;
	var opts;
	var fcn;
...
test( 'function returns a function which returns a package hash containing package info to a provided callback', function test( t ) {
	var expected;
	var factory;
	var opts;
	var fcn;
